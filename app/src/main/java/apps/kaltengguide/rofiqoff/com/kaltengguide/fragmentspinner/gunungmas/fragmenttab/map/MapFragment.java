package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.gunungmas.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-1.033556,113.603477);
    ...
    String link_url = isi + "tampil-marker-gunung-mas.php";
...
//                goToLocationZoom(-1.033556, 113.603477, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-1.033556, 113.603477)).title("Gunung Mas")).setSnippet("Gunung Mas");
