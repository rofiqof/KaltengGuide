package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.pulangpisau.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-2.612133, 114.046199);
    ...
    String link_url = isi + "tampil-marker-pulang-pisau.php";
...
//                goToLocationZoom(-2.612133, 114.046199, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-2.612133, 114.046199)).title("Kabupaten Pulang Pisau")).setSnippet("Kabupaten Pulang Pisau");
