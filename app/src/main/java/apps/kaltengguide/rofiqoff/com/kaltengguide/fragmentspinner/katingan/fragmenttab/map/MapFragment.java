package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.katingan.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-1.500464, 113.173949);
    ...
    String link_url = isi + "tampil-marker-katingan.php";
...
//                goToLocationZoom(-1.500464, 113.173949, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-1.500464, 113.173949)).title("Kabupaten Katingan")).setSnippet("Kabupaten Katingan");
