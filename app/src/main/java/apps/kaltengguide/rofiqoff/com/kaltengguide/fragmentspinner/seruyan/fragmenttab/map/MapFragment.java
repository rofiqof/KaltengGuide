package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.seruyan.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-2.080154, 112.187238);
    ...
    String link_url = isi + "tampil-marker-seruyan.php";
...
//
//                goToLocationZoom(-2.080154, 112.187238, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-2.080154, 112.187238)).title("Kabupaten Regency")).setSnippet("Kabupaten Regency");
