package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.kotawaringintimur.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-2.021365, 112.709677);
    ...
    String link_url = isi + "tampil-marker-waringin-timur.php";
...
//                goToLocationZoom(-2.021365, 112.709677, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-2.021365, 112.709677)).title("Kotawaringin Timur")).setSnippet("Kotawaringin Timur");
