package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.lamnadau.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-1.763302, 111.363575);
    ...
    String link_url = isi + "tampil-marker-lamandau.php";
...
//                goToLocationZoom(-1.763302, 111.363575, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-1.763302, 111.363575)).title("Kabupaten Lamandau")).setSnippet("Kabupaten Lamandau");
