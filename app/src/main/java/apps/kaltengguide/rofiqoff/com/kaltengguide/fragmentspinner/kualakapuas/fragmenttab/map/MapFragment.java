package apps.kaltengguide.rofiqoff.com.kaltengguide.fragmentspinner.kualakapuas.fragmenttab.map;
...
public class MapFragment extends Fragment {
    ...
    static final LatLng AWAL = new LatLng(-2.976459, 114.386911);
    ...
    String link_url = isi + "tampil-marker-kuala-kapuas.php";
...
//                goToLocationZoom(-2.976459, 114.386911, 10);
//
//                mGoogleMap.addMarker(new MarkerOptions().position(new LatLng(-2.976459, 114.386911)).title("Kabupaten Kuala Kapuas")).setSnippet("Kabupaten Kuala Kapuas");
